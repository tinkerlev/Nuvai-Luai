In this project always use clean and professional UI with modern and visually appealing spacing, typography and UX.

Use Tailwind and daisyUI components to provide consistent UI.
